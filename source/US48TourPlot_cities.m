...
text(coord(:,2),coord(:,3),num2str(coord(:,1)),'HorizontalAlignment','center','VerticalAlignment','bottom')
text(coord(:,2),coord(:,3),cities(:,2),'HorizontalAlignment','center','VerticalAlignment','top')
